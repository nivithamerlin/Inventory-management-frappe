...
app_publisher = "nivitha"
app_description = "inventory app"
...
scheduler_events = {
    "daily": [
        "inventory_app.utils.reorder_alerts.check_reorder_levels"
        "inventory_app.scripts.low_stock_notifications.daily_low_stock_summary"
    ]
}
